...
# Define polygon source points (calibration)
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--source_video_path", required=True, type=str, help="Input video path")
    parser.add_argument("--target_video_path", required=True, type=str, help="Output video path")
    parser.add_argument("--confidence_threshold", default=0.3, type=float, help="Confidence threshold")
    parser.add_argument("--iou_threshold", default=0.7, type=float, help="IOU threshold")
    return parser.parse_args()

if __name__ == "__main__":
    args = parse_arguments()

    # Load Ultralytics YOLO-NAS-L model
